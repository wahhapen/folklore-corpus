# Folklore Corpus agent guide

## Repository status

Trusted evidence custodian. Published releases remain immutable. The current
approved boundary forbids Corpus v0.4, new source acquisition, and new ingestion
work until a later phase explicitly authorizes them.
